...
{
    public class ReadUserImagesFromDb : ImgProcessorHandler
    {
        private readonly Dictionary<ImageType, ImageUpdateParams> _imageSizes;
        public ReadUserImagesFromDb()
        {
        ...
        public override void HandleImage(ImgProcessorHandlerTarget imageHandlerTarget)
        {
            ...
            imageHandlerTarget.Images = Ioc.Get<IImageDataService>().GetUserImages(imageHandlerTarget.UserId, imageHandlerTarget.Sequence).ConvertAll(x=> (IUserImg)x);
