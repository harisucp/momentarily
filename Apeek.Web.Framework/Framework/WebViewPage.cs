...
namespace Apeek.Web.Framework
{
    public abstract class WebViewPage<TModel> : System.Web.Mvc.WebViewPage<TModel>
    {
        ...
        public bool IsActiveLink(RouteValueDictionary routeValue)
        {
            return IsActiveLink(routeValue["action"].ToString(), routeValue["controller"].ToString());
        }
        public bool IsActiveLink(string action, string controller)
        {
            return (ViewContext.RouteData.Values["action"].ToString() == action) && (ViewContext.RouteData.Values["controller"].ToString() == controller);
        }
